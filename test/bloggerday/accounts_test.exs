defmodule Bloggerday.AccountsTest do
  use Bloggerday.DataCase

  alias Bloggerday.Accounts
  import Bloggerday.AccountsFixtures
  alias Bloggerday.Accounts.{User, UserToken}
  ...
  describe "change_user_registration/2" do
    test "returns a changeset" do
      ...
      assert changeset.required == [:password, :email, :first_name, :last_name, :gender, :email]
    end
