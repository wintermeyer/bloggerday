defmodule Bloggerday.Accounts.User do
  use Ecto.Schema
  ...
  def email_changeset(user, attrs) do
    ...
    |> case do
      ...
      %{} = changeset -> add_error(changeset, :email, "wurde nicht geändert")
    end
  end
  ...
  def password_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:password])
    |> validate_confirmation(:password, message: "Passwort stimmt nicht überein")
    |> validate_password(opts)
  end
  ...
  """
  def valid_password?(%Bloggerday.Accounts.User{hashed_password: hashed_password}, password)
  ...
  def validate_current_password(changeset, password) do
    if valid_password?(changeset.data, password) do
      ...
      add_error(changeset, :current_password, "stimmt nicht")
    end
  end
end
